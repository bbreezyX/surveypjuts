...
map.getView().fit([11247891.880938, -339447.234704, 11642527.173157, -51162.925274], map.getSize());
...
if (bottomAttributionUl) {
  // Strip any whitespace-only items already rendered by OL from source attributions
  Array.from(bottomAttributionUl.querySelectorAll('li')).forEach(function(li) {
    if (!li.textContent.trim()) li.remove();
  });
  [
    { label: 'qgis2web', href: 'https://github.com/qgis2web/qgis2web' },
    { label: 'OpenLayers', href: 'https://openlayers.org/' },
    { label: 'QGIS', href: 'https://qgis.org/' },
    ...
    li.appendChild(a);
    bottomAttributionUl.appendChild(li);
  });
}
